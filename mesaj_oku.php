...
<?php
  ...
  if($_SESSION){
	  ...
	  if($x){
        ...
        ?>
      <div class="mesaj_oku">
	    <h2><span style="font-weight:bold">Başlık :</span> <?php echo mb_substr($m["mesaj_baslik"],0,45);?>
	    <span style="float:right;"><?php echo $m["mesaj_tarih"];?></span></h2>
	    <p>
	    <span style="font-weight:bold;text-decoration:underline;">Gönderen : <?php echo $m["mesaj_gonderen"];?></span> <br /> <br />
