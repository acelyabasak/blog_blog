       ...
       foreach($c as $m){
		   if($m["mesaj_kime"] == $_SESSION["id"]){
			 ...
			 <span style="font-weight:bold;">Gönderen : </span> <?php echo $m["mesaj_gonderen"];?>
			   ...
			   <span style="font-weight:bold;margin-left:3px;"><a onclick="return confirm('Mesajı silmek istediğinize emin misiniz..?')" href="?do=mesaj_sil&id=<?php echo $m["mesaj_id"];?>">sil</a></span></span>
			 </li>
			 </ul>
			 </div>
			 <?php
			 ...
			 <span style="font-weight:bold;">Gönderen : </span> <?php echo $m["mesaj_gonderen"];?>
			   <span style="font-weight:bold;">Başlık :  </span> <?php echo mb_substr($m["mesaj_baslik"],0,25);?></a>
			   <span style="float:right;"><?php echo $m["mesaj_tarih"];?>
			   <span style="font-weight:bold;margin-left:3px;"><a  style="color:black;" href="?do=mesaj_sil&id=<?php echo $m["mesaj_id"];?>">Sil</a></span></span>
			 </li>
			 </ul>
			 </div>
			 <?php
