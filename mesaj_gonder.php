...
<?php
  if($_SESSION){
      ...
      $x = $v->rowCount();
          ...
          if($x){
           ...
           if($k){
			 ...
			 echo '<div class="basarili2">Mesajınız başarıyla gönderilmiştir...</div>';
			...
			echo '<div class="hata"><span style="color:red;">'.$isim.'</span> adlı üye sistemde kayıtlı gözükmüyor..</div>';
		  }
	   }
	  }
    else {
    ...
    <form action="" method="post">
	  ...
	  echo '<div class="hata">Mesaj göndermek için üyeliğinizle giriş yapmanız gerekiyor... </div>';
  }
?>
