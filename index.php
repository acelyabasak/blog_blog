...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>DarkSwan</title>
  </head>
  <body>
    <div class="genel">
      <div class="header">
        <h2><span style="color:	#006064;">Dark</span>Swan</h2>
        <div class="reklam">
      ...
      <div class="menu">
        <ul>
          ...
          if(!$_SESSION){
           ...
           ?>
          <li><a href="?do=iletisim">iletişim</a></li>
        </ul>
        <form action="?do=ara" method="post">
        <span><input type="text" name="ara" value=""><button type="submit">ara</button> </span>
        </form>
      </div>
           ...
           case 'ara':
            ...
            case 'konu_ekle':
              ...
              case 'cikis':
                ...
                echo '<div class="basarili2">Başarıyla cıkış yaptınız. Yönlendiriliyorsunuz.</div>';
                break;
      ...
      <div class="footer">
        <h2>copright 2020 DarkSwan theme by acelyabasak</h2>
      </div>
    </div>
  </body>
</html>
