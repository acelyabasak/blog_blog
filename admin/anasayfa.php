...
<div class="admin-icerik-sag">
			...
			<div class="anasayfa">
			<h3><a href="./?do=konular">Konular</a></h3>
			...
			<div class="anasayfa">
			<h3><a href="./?do=uyeler">Üyeler</a></h3>
			<p>
			...
			<div class="anasayfa">
			<h3><a href="./?do=yorumlar">Yorumlar</a></h3>
			<p>
			...
			<div class="anasayfa">
			<h3><a href="./?do=kategoriler">Kategoriler</a></h3>
			<p>Toplam Kategori : <?php echo $kategori;?></p>
			</div>
			<div class="anasayfa">
			<h3><a href="./?do=sabit_sayfalar">Sabit Sayfalar</a></h3>
