<div class="admin-icerik-sag">
			...
			if($_POST){
			  ...
			  echo '<div class="hata">Bu mail adresi gecerli değil baska bir tane deneyin</div>';
					...
					if($insert){
						...
						echo '<div class="basarili2">Üye basarıyla eklendi...</div>';

						header("refresh: 2; url=./?do=uyeler");

					}else {

						echo '<div class="hata">Üye eklenirken bir hata olustu..</div>';
				...
				<li><button type="submit">Üye Ekle</button></li>
				</ul>
				</form>
				</div>
				<?php
