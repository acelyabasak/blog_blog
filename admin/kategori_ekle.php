			...
			if($_POST){
				...
				if(!$adi || !$aciklama){
					...
					if($x){
					   ...
					   echo '<div class="hata"><span style="color:red;">'.$adi.'</span> adında bir kategori daha once acılmıs baska deneyin...</div>';
					...
					if($update){
						...
						echo '<div class="basarili2">Kategori basarıyla eklendi...</div>';

						header("refresh: 2; url=./?do=kategoriler");

					}else {

						echo '<div class="hata">Kategori eklenirken bir hata olustu..</div>';
