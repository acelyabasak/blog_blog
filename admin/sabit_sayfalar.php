...
<div class="admin-icerik-sag">
			<h2>Sabit Sayfalar <span style="float:right;"><a href="./?do=sayfa_ekle">Sayfa Ekle</a></span></h2>
			<div class="konular">
			...
			<?php
			 if($x){
                foreach($k as $m){
					...
					<a href="./?do=sayfa_duzenle&id=<?php echo $m["sayfa_id"];?>">Düzenle</a></span> <span style="margin-left:10px;"><a  onclick="return confirm('Sayfayı silmek istediğinize emin misiniz..')" href="./?do=sayfa_sil&id=<?php echo $m["sayfa_id"];?>">Sil</a></span></td>
					</tr>
					</tbody>
					<?php
				}
